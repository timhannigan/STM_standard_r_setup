...
plot(est_30, "year", method="continuous", topics=c(29, 18), xlim=c(1999,2021), xlab = "Year", labeltype = "custom", custom.labels = c("Topic 29 research evidence", "Topic 18 integrative review"))
